...
python3 compare_ids_benchmarks.py --scenario santos --custom santos_alerts.jsonl --dedup-window 5
...
python3 compare_ids_benchmarks.py --scenario russellmitchell --custom russellmitchell_alerts.jsonl --dedup-window 5
...
python3 compare_ids_benchmarks.py --scenario fox --custom fox_alerts.jsonl --dedup-window 5
...
python3 compare_ids_benchmarks.py --scenario wardbeck --custom wardbeck_alerts.jsonl --dedup-window 5
...
python3 compare_ids_benchmarks.py --scenario harrison --custom harrison_alerts.jsonl --dedup-window 5
